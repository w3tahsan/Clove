                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-wrap">
                            ...
                            @empty
                                <span class="badge badge-secondary my-1">Not Assigned</span>
                            @endforelse
                        </td>
                        <td>
                ...
                <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <label class="form-check-label">
                            <input name="permission[]" type="checkbox" value="{{ $permission->name }}" class="form-check-input">
                            {{ $permission->name }}
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form action="{{ route('role.assign') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary">Assgin Role</button>
                    </div>
                </form>
            </div>
        </div>
